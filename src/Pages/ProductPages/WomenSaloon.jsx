  ...
  return (
    <Container maxW="full" p={9}>
      ...
      <Container maxW="full" p={4}>
        ...
        >
          <Box>
            <Heading>Appliance Repair</Heading>
          </Box>
          <Box>
            <Carousels />
          </Box>
          ...
          <Link to="#waxing" smooth>
            <Box w="100%" _hover={{ bg: "#E2E8F0" }} p={2} variant="ghost">
              <Center>
                <Image
                  rounded={"md"}
                  src="https://github.com/atulya15/image/blob/main/ap3.jpeg?raw=true"
                  alt="logo"
                />
              </Center>

              <Text mt="15px">AC Repair</Text>
            </Box>
          </Link>
          <Link to="#Facial" smooth>
            <Box w="100%" _hover={{ bg: "#E2E8F0" }} p={2} variant="ghost">
              <Center>
                <Image
                  rounded={"md"}
                  src="https://github.com/atulya15/image/blob/main/ap4.jpeg?raw=true"
                  alt="logo"
                />
              </Center>

              <Text mt="15px">Fridge Repair</Text>
            </Box>
          </Link>
          <Link to="#Manicure" smooth>
            <Box w="100%" _hover={{ bg: "#E2E8F0" }} p={2} variant="ghost">
              <Center>
                <Image
                  rounded={"md"}
                  src="https://github.com/atulya15/image/blob/main/ap5.jpeg?raw=true"
                  alt="logo"
                />
              </Center>

              <Text mt="15px">TV repair</Text>
            </Box>
          </Link>
